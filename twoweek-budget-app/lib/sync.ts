...
// Pulls fresh transactions for a household from SimpleFIN, categorizes them,
// and upserts them into the transactions table. Shared by the manual
// "Sync now" route and the daily cron route.
